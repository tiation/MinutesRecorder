---
layout: default
title: Minutesrecorder - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Minutesrecorder</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/MinutesRecorder" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t MinutesRecorder .

# Run container
docker run -p 8080:8080 MinutesRecorder
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/MinutesRecorder)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/MinutesRecorder/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/MinutesRecorder/discussions)
